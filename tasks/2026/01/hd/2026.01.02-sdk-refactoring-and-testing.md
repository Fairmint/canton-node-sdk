...
- [ ] Phase 4: Architecture & Docs
  ...
  - [x] Add comprehensive JSDoc
  - [x] Add examples
- [x] Tests passing (248 unit tests)
...
- ✅ `src/utils/party/createParty.ts` - Tests added, uses polling utilities
- ✅ `src/utils/amulet/transfer-to-preapproved.ts` - Tests added
- ✅ `src/utils/external-signing/*.ts` - Tests added for all files
- ✅ `src/utils/amulet/offers.ts` - Tests added
- ✅ `src/utils/amulet/pre-approve-transfers.ts` - Tests added
- ✅ `src/utils/mining/mining-rounds.ts` - Tests added

### Lower Priority (improve ergonomics)
- `src/core/http/HttpClient.ts` - Retry logic could use more tests
