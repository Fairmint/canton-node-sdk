...
export const GetEventById = createApiOperation<paths['/v0/events/{update_id}']['get']['parameters']['path'] & paths['/v0/events/{update_id}']['get']['parameters']['query'], paths['/v0/events/{update_id}']['get']['responses']['200']['content']['application/json']>({
