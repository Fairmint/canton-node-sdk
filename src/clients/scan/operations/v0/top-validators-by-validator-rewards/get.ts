...
export const GetTopValidatorsByValidatorRewards = createApiOperation<paths['/v0/top-validators-by-validator-rewards']['get']['parameters']['query'], paths['/v0/top-validators-by-validator-rewards']['get']['responses']['200']['content']['application/json']>({
