...
export const GetUpdateByIdV2 = createApiOperation<paths['/v2/updates/{update_id}']['get']['parameters']['path'] & paths['/v2/updates/{update_id}']['get']['parameters']['query'], paths['/v2/updates/{update_id}']['get']['responses']['200']['content']['application/json']>({
  ...
  buildUrl: (params, apiUrl) => {
    let url = `${apiUrl}/v2/updates/${params.update_id}`;
