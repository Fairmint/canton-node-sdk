...
import { EventsByContractIdParams } from './operations/v2/events/get-events-by-contract-id';
import type { paths } from '../../openapi-types';

// Type alias for the response type
type GetEventsByContractIdResponse = paths['/v2/events/events-by-contract-id']['post']['responses']['200']['content']['application/json'];
