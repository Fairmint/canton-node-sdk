 ...
 *
 * `.passthrough()` keeps unknown wire fields on parse output so subscribe-to-updates can deliver
 * normalized Zod output (null → undefined) without stripping newer Ledger fields.
 */
export const CreatedEventDetailsSchema = z
  .object({
...
export const ArchivedEventDetailsSchema = z
  .object({
    /** Offset of the event in the ledger stream. */
    offset: z.number(),
    /** Node ID of the event in the transaction tree. */
...
export const ExercisedEventDetailsSchema = z
  .object({
    /** Offset of the event in the ledger stream. */
    offset: z.number(),
    /** Node ID of the event in the transaction tree. */
...
export const AssignedEventDetailsSchema = z
  .object({
    /** Offset of the event in the ledger stream. */
    offset: z.number(),
    /** Node ID of the event in the transaction tree. */
...
export const UnassignedEventDetailsSchema = z
  .object({
    /** Offset of the event in the ledger stream. */
    offset: z.number(),
    /** Node ID of the event in the transaction tree. */
