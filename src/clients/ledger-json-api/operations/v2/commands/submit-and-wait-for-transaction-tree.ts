...
import { SubmitAndWaitForTransactionTreeParamsSchema, SubmitAndWaitForTransactionTreeParams } from '../../../schemas/operations';
import { JsSubmitAndWaitForTransactionTreeResponse } from '../../../schemas/api';
...
>({
  ...
  method: 'POST',
  buildUrl: (_params: SubmitAndWaitForTransactionTreeParams, apiUrl: string) => `${apiUrl}/v2/commands/submit-and-wait-for-transaction-tree`,
  buildRequestData: (params: SubmitAndWaitForTransactionTreeParams, client) => {
