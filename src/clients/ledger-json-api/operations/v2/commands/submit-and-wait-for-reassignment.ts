...
import {
  SubmitAndWaitForReassignmentParamsSchema,
  type SubmitAndWaitForReassignmentParams,
...
>({
  ...
  method: 'POST',
  buildUrl: (_params: SubmitAndWaitForReassignmentParams, apiUrl: string) =>
    `${apiUrl}/v2/commands/submit-and-wait-for-reassignment`,
