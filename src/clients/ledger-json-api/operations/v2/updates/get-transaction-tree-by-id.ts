...
export type GetTransactionTreeByIdResponse =
 ...
 */
export const GetTransactionTreeById = createApiOperation<GetTransactionTreeByIdParams, GetTransactionTreeByIdResponse>({
