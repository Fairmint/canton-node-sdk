...
const MAINNET_ENDPOINTS: readonly ScanSvEndpoint[] = [
  { svName: 'C7-Technology-Services-Limited', hostUrl: 'https://scan.sv-1.global.canton.network.c7.digital', version: '0.5.4' },
  ...
  { svName: 'Global-Synchronizer-Foundation', hostUrl: 'https://scan.sv-1.global.canton.network.sync.global', version: '0.5.4' },
  { svName: 'Liberty-City-Ventures-1', hostUrl: 'https://scan.sv-1.global.canton.network.lcv.mpch.io', version: '0.5.4' },
...
const DEVNET_ENDPOINTS: readonly ScanSvEndpoint[] = [
  { svName: 'C7-Technology-Services-Limited', hostUrl: 'https://scan.sv-1.dev.global.canton.network.c7.digital', version: '0.5.4' },
  ...
  { svName: 'DA-Helm-Test-Node', hostUrl: 'https://scan.sv.dev.global.canton.network.digitalasset.com', version: '0.5.4' },
  { svName: 'Digital-Asset-1', hostUrl: 'https://scan.sv-1.dev.global.canton.network.digitalasset.com', version: '0.5.4' },
  { svName: 'Digital-Asset-2', hostUrl: 'https://scan.sv-2.dev.global.canton.network.digitalasset.com', version: '0.5.4' },
  { svName: 'Five-North-1', hostUrl: 'https://scan.sv-1.dev.global.canton.network.fivenorth.io', version: '0.5.4' },
  { svName: 'Global-Synchronizer-Foundation', hostUrl: 'https://scan.sv-1.dev.global.canton.network.sync.global', version: '0.5.4' },
  { svName: 'Liberty-City-Ventures-1', hostUrl: 'https://scan.sv-1.dev.global.canton.network.lcv.mpch.io', version: '0.5.4' },
  ...
  { svName: 'SV-Nodeops-Limited', hostUrl: 'https://scan.sv.dev.global.canton.network.sv-nodeops.com', version: '0.5.4' },
  { svName: 'Tradeweb-Markets-1', hostUrl: 'https://scan.sv-1.dev.global.canton.network.tradeweb.com', version: '0.5.4' },
];
