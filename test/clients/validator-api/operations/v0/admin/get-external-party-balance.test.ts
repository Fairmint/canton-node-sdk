...
import { GetExternalPartyBalance } from '../../../../../../src/GetExternalPartyBalance';
import { mockClientConfig, mockApiUrls } from '../../../../../config/testConfig';

describe('GetExternalPartyBalance Operation', () => {
  let mockClient: MockValidatorApiClient;
  let operation: InstanceType<typeof GetExternalPartyBalance>;

  beforeEach(() => {
    mockClient = new MockValidatorApiClient(mockClientConfig);
    operation = new GetExternalPartyBalance(mockClient);
