...
import { GetBuyTrafficRequestStatus } from '../../../../../../../src/GetBuyTrafficRequestStatus';
import { mockClientConfig, mockApiUrls } from '../../../../../../config/testConfig';

describe('GetBuyTrafficRequestStatus Operation', () => {
  let mockClient: MockValidatorApiClient;
  let operation: InstanceType<typeof GetBuyTrafficRequestStatus>;

  beforeEach(() => {
    mockClient = new MockValidatorApiClient(mockClientConfig);
    operation = new GetBuyTrafficRequestStatus(mockClient);
