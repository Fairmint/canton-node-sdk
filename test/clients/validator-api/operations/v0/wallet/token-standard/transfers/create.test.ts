...
import { CreateTokenStandardTransfer } from '../../../../../../../../src/CreateTokenStandardTransfer';
import { mockClientConfig, mockApiUrls } from '../../../../../../../config/testConfig';

describe('CreateTokenStandardTransfer Operation', () => {
  let mockClient: MockValidatorApiClient;
  let operation: InstanceType<typeof CreateTokenStandardTransfer>;

  beforeEach(() => {
    mockClient = new MockValidatorApiClient(mockClientConfig);
    operation = new CreateTokenStandardTransfer(mockClient);
