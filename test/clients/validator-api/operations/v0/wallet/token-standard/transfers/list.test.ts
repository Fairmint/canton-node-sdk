...
import { ListTokenStandardTransfers } from '../../../../../../../../src/ListTokenStandardTransfers';
import { mockClientConfig, mockApiUrls } from '../../../../../../../config/testConfig';

describe('ListTokenStandardTransfers Operation', () => {
  let mockClient: MockValidatorApiClient;
  let operation: InstanceType<typeof ListTokenStandardTransfers>;

  beforeEach(() => {
    mockClient = new MockValidatorApiClient(mockClientConfig);
    operation = new ListTokenStandardTransfers(mockClient);
