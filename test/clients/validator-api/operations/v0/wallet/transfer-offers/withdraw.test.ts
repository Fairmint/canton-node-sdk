...
import { WithdrawTransferOffer } from '../../../../../../../src/WithdrawTransferOffer';
import { mockClientConfig, mockApiUrls } from '../../../../../../config/testConfig';

describe('WithdrawTransferOffer Operation', () => {
  let mockClient: MockValidatorApiClient;
  let operation: InstanceType<typeof WithdrawTransferOffer>;

  beforeEach(() => {
    mockClient = new MockValidatorApiClient(mockClientConfig);
    operation = new WithdrawTransferOffer(mockClient);
