...
import { ListTransferOffers } from '../../../../../../../src/ListTransferOffers';
import { mockClientConfig, mockApiUrls } from '../../../../../../config/testConfig';

describe('ListTransferOffers Operation', () => {
  let mockClient: MockValidatorApiClient;
  let operation: InstanceType<typeof ListTransferOffers>;

  beforeEach(() => {
    mockClient = new MockValidatorApiClient(mockClientConfig);
    operation = new ListTransferOffers(mockClient);
