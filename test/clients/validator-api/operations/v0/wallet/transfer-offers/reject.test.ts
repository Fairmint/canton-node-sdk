...
import { RejectTransferOffer } from '../../../../../../../src/RejectTransferOffer';
import { mockClientConfig, mockApiUrls } from '../../../../../../config/testConfig';

describe('RejectTransferOffer Operation', () => {
  let mockClient: MockValidatorApiClient;
  let operation: InstanceType<typeof RejectTransferOffer>;

  beforeEach(() => {
    mockClient = new MockValidatorApiClient(mockClientConfig);
    operation = new RejectTransferOffer(mockClient);
