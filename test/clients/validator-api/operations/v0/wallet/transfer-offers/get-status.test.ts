...
import { GetTransferOfferStatus } from '../../../../../../../src/GetTransferOfferStatus';
import { mockClientConfig, mockApiUrls } from '../../../../../../config/testConfig';

describe('GetTransferOfferStatus Operation', () => {
  let mockClient: MockValidatorApiClient;
  let operation: InstanceType<typeof GetTransferOfferStatus>;

  beforeEach(() => {
    mockClient = new MockValidatorApiClient(mockClientConfig);
    operation = new GetTransferOfferStatus(mockClient);
