...
import { CreateTransferOffer } from '../../../../../../../src/CreateTransferOffer';
import { mockClientConfig, mockApiUrls } from '../../../../../../config/testConfig';

describe('CreateTransferOffer Operation', () => {
  let mockClient: MockValidatorApiClient;
  let operation: InstanceType<typeof CreateTransferOffer>;

  beforeEach(() => {
    mockClient = new MockValidatorApiClient(mockClientConfig);
    operation = new CreateTransferOffer(mockClient);
