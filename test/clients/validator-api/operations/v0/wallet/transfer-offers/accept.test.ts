...
import { AcceptTransferOffer } from '../../../../../../../src/AcceptTransferOffer';
import { mockClientConfig, mockApiUrls } from '../../../../../../config/testConfig';

describe('AcceptTransferOffer Operation', () => {
  let mockClient: MockValidatorApiClient;
  let operation: InstanceType<typeof AcceptTransferOffer>;

  beforeEach(() => {
    mockClient = new MockValidatorApiClient(mockClientConfig);
    operation = new AcceptTransferOffer(mockClient);
