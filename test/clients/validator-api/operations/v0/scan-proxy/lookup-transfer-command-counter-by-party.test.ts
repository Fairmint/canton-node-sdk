...
import { LookupTransferCommandCounterByParty } from '../../../../../../src/LookupTransferCommandCounterByParty';
import { mockClientConfig, mockApiUrls } from '../../../../../config/testConfig';

describe('LookupTransferCommandCounterByParty Operation', () => {
  let mockClient: MockValidatorApiClient;
  let operation: InstanceType<typeof LookupTransferCommandCounterByParty>;

  beforeEach(() => {
    mockClient = new MockValidatorApiClient(mockClientConfig);
    operation = new LookupTransferCommandCounterByParty(mockClient);
