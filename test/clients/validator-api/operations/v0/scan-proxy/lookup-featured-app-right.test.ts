...
import { LookupFeaturedAppRight } from '../../../../../../src/LookupFeaturedAppRight';
import { mockClientConfig, mockApiUrls } from '../../../../../config/testConfig';

describe('LookupFeaturedAppRight Operation', () => {
  let mockClient: MockValidatorApiClient;
  let operation: InstanceType<typeof LookupFeaturedAppRight>;

  beforeEach(() => {
    mockClient = new MockValidatorApiClient(mockClientConfig);
    operation = new LookupFeaturedAppRight(mockClient);
  ...
  describe('Network Activity Validation', () => {
    it('should make a GET request to the correct endpoint', async () => {
      ...
      const params = {};
      const mockResponse = {};
      const expectedUrl = `${mockApiUrls.VALIDATOR_API}/v0/scan-proxy/featured-apps/{provider_party_id}`;
