...
import { ListInstruments } from '../../../../../../../../../src/clients/validator-api/operations/v0/scan-proxy/registry/metadata/v1/list-instruments';
import { mockClientConfig, mockApiUrls } from '../../../../../../../../config/testConfig';

describe('ListInstruments Operation', () => {
  let mockClient: MockValidatorApiClient;
  let operation: InstanceType<typeof ListInstruments>;

  beforeEach(() => {
    mockClient = new MockValidatorApiClient(mockClientConfig);
    operation = new ListInstruments(mockClient);
