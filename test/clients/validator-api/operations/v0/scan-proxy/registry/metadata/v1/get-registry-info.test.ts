...
import { GetRegistryInfo } from '../../../../../../../../../src/clients/validator-api/operations/v0/scan-proxy/registry/metadata/v1/get-registry-info';
import { mockClientConfig, mockApiUrls } from '../../../../../../../../config/testConfig';

describe('GetRegistryInfo Operation', () => {
  let mockClient: MockValidatorApiClient;
  let operation: InstanceType<typeof GetRegistryInfo>;

  beforeEach(() => {
    mockClient = new MockValidatorApiClient(mockClientConfig);
    operation = new GetRegistryInfo(mockClient);
  ...
  describe('Network Activity Validation', () => {
    it('should make a GET request to the correct endpoint', async () => {
      ...
      const mockResponse = {};
      const expectedUrl = `${mockApiUrls.VALIDATOR_API}/api/validator/v0/scan-proxy/registry/metadata/v1/info`;
