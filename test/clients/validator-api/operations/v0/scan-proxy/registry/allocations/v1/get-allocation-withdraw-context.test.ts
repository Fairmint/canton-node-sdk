...
import { GetAllocationWithdrawContext } from '../../../../../../../../../src/GetAllocationWithdrawContext';
import { mockClientConfig, mockApiUrls } from '../../../../../../../../config/testConfig';

describe('GetAllocationWithdrawContext Operation', () => {
  let mockClient: MockValidatorApiClient;
  let operation: InstanceType<typeof GetAllocationWithdrawContext>;

  beforeEach(() => {
    mockClient = new MockValidatorApiClient(mockClientConfig);
    operation = new GetAllocationWithdrawContext(mockClient);
