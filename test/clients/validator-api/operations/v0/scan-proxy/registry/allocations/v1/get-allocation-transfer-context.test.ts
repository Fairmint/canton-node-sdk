...
import { GetAllocationTransferContext } from '../../../../../../../../../src/GetAllocationTransferContext';
import { mockClientConfig, mockApiUrls } from '../../../../../../../../config/testConfig';

describe('GetAllocationTransferContext Operation', () => {
  let mockClient: MockValidatorApiClient;
  let operation: InstanceType<typeof GetAllocationTransferContext>;

  beforeEach(() => {
    mockClient = new MockValidatorApiClient(mockClientConfig);
    operation = new GetAllocationTransferContext(mockClient);
  ...
  describe('Network Activity Validation', () => {
    it('should make a POST request to the correct endpoint', async () => {
      ...
      const params = {};
      const mockResponse = {};
      const expectedUrl = `${mockApiUrls.VALIDATOR_API}/api/validator/v0/scan-proxy/registry/allocations/v1`;
