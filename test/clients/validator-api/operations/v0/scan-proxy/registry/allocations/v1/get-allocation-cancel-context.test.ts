...
import { GetAllocationCancelContext } from '../../../../../../../../../src/GetAllocationCancelContext';
import { mockClientConfig, mockApiUrls } from '../../../../../../../../config/testConfig';

describe('GetAllocationCancelContext Operation', () => {
  let mockClient: MockValidatorApiClient;
  let operation: InstanceType<typeof GetAllocationCancelContext>;

  beforeEach(() => {
    mockClient = new MockValidatorApiClient(mockClientConfig);
    operation = new GetAllocationCancelContext(mockClient);
