...
import { GetAllocationFactory } from '../../../../../../../../../src/GetAllocationFactory';
import { mockClientConfig, mockApiUrls } from '../../../../../../../../config/testConfig';

describe('GetAllocationFactory Operation', () => {
  let mockClient: MockValidatorApiClient;
  let operation: InstanceType<typeof GetAllocationFactory>;

  beforeEach(() => {
    mockClient = new MockValidatorApiClient(mockClientConfig);
    operation = new GetAllocationFactory(mockClient);
  ...
  describe('Network Activity Validation', () => {
    it('should make a POST request to the correct endpoint', async () => {
      ...
      const params = {};
      const mockResponse = {};
      const expectedUrl = `${mockApiUrls.VALIDATOR_API}/api/validator/v0/scan-proxy/registry/allocation-instruction/v1/allocation-factory`;
