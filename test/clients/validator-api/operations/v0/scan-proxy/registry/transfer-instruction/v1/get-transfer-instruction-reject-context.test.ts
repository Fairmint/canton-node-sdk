...
import { GetTransferInstructionRejectContext } from '../../../../../../../../../src/GetTransferInstructionRejectContext';
import { mockClientConfig, mockApiUrls } from '../../../../../../../../config/testConfig';

describe('GetTransferInstructionRejectContext Operation', () => {
  let mockClient: MockValidatorApiClient;
  let operation: InstanceType<typeof GetTransferInstructionRejectContext>;

  beforeEach(() => {
    mockClient = new MockValidatorApiClient(mockClientConfig);
    operation = new GetTransferInstructionRejectContext(mockClient);
