...
import { GetTransferInstructionAcceptContext } from '../../../../../../../../../src/GetTransferInstructionAcceptContext';
import { mockClientConfig, mockApiUrls } from '../../../../../../../../config/testConfig';

describe('GetTransferInstructionAcceptContext Operation', () => {
  let mockClient: MockValidatorApiClient;
  let operation: InstanceType<typeof GetTransferInstructionAcceptContext>;

  beforeEach(() => {
    mockClient = new MockValidatorApiClient(mockClientConfig);
    operation = new GetTransferInstructionAcceptContext(mockClient);
