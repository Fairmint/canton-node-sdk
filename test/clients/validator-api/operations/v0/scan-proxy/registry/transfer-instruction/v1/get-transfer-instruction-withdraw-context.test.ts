...
import { GetTransferInstructionWithdrawContext } from '../../../../../../../../../src/GetTransferInstructionWithdrawContext';
import { mockClientConfig, mockApiUrls } from '../../../../../../../../config/testConfig';

describe('GetTransferInstructionWithdrawContext Operation', () => {
  let mockClient: MockValidatorApiClient;
  let operation: InstanceType<typeof GetTransferInstructionWithdrawContext>;

  beforeEach(() => {
    mockClient = new MockValidatorApiClient(mockClientConfig);
    operation = new GetTransferInstructionWithdrawContext(mockClient);
