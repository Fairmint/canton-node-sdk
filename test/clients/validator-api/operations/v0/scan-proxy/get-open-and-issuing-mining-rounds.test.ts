...
import { GetOpenAndIssuingMiningRounds } from '../../../../../../src/GetOpenAndIssuingMiningRounds';
import { mockClientConfig, mockApiUrls } from '../../../../../config/testConfig';

describe('GetOpenAndIssuingMiningRounds Operation', () => {
  let mockClient: MockValidatorApiClient;
  let operation: InstanceType<typeof GetOpenAndIssuingMiningRounds>;

  beforeEach(() => {
    mockClient = new MockValidatorApiClient(mockClientConfig);
    operation = new GetOpenAndIssuingMiningRounds(mockClient);
