...
import { LookupTransferPreapprovalByParty } from '../../../../../../src/LookupTransferPreapprovalByParty';
import { mockClientConfig, mockApiUrls } from '../../../../../config/testConfig';

describe('LookupTransferPreapprovalByParty Operation', () => {
  let mockClient: MockValidatorApiClient;
  let operation: InstanceType<typeof LookupTransferPreapprovalByParty>;

  beforeEach(() => {
    mockClient = new MockValidatorApiClient(mockClientConfig);
    operation = new LookupTransferPreapprovalByParty(mockClient);
