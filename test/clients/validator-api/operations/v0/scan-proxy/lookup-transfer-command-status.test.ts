...
import { LookupTransferCommandStatus } from '../../../../../../src/LookupTransferCommandStatus';
import { mockClientConfig, mockApiUrls } from '../../../../../config/testConfig';

describe('LookupTransferCommandStatus Operation', () => {
  let mockClient: MockValidatorApiClient;
  let operation: InstanceType<typeof LookupTransferCommandStatus>;

  beforeEach(() => {
    mockClient = new MockValidatorApiClient(mockClientConfig);
    operation = new LookupTransferCommandStatus(mockClient);
