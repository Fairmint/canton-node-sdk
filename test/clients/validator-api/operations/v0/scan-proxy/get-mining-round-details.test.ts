...
import { GetMiningRoundDetails } from '../../../../../../src/GetMiningRoundDetails';
import { mockClientConfig, mockApiUrls } from '../../../../../config/testConfig';

describe('GetMiningRoundDetails Operation', () => {
  let mockClient: MockValidatorApiClient;
  let operation: InstanceType<typeof GetMiningRoundDetails>;

  beforeEach(() => {
    mockClient = new MockValidatorApiClient(mockClientConfig);
    operation = new GetMiningRoundDetails(mockClient);
