...
import { CreateAnsEntry } from '../../../../../../src/CreateAnsEntry';
import { mockClientConfig, mockApiUrls } from '../../../../../config/testConfig';

describe('CreateAnsEntry Operation', () => {
  let mockClient: MockValidatorApiClient;
  let operation: InstanceType<typeof CreateAnsEntry>;

  beforeEach(() => {
    mockClient = new MockValidatorApiClient(mockClientConfig);
    operation = new CreateAnsEntry(mockClient);
