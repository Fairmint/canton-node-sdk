...
import { ListAnsEntries } from '../../../../../../src/ListAnsEntries';
import { mockClientConfig, mockApiUrls } from '../../../../../config/testConfig';

describe('ListAnsEntries Operation', () => {
  let mockClient: MockValidatorApiClient;
  let operation: InstanceType<typeof ListAnsEntries>;

  beforeEach(() => {
    mockClient = new MockValidatorApiClient(mockClientConfig);
    operation = new ListAnsEntries(mockClient);
