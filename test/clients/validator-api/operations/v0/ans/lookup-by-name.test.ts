...
import { LookupAnsEntryByName } from '../../../../../../src/LookupAnsEntryByName';
import { mockClientConfig, mockApiUrls } from '../../../../../config/testConfig';

describe('LookupAnsEntryByName Operation', () => {
  let mockClient: MockValidatorApiClient;
  let operation: InstanceType<typeof LookupAnsEntryByName>;

  beforeEach(() => {
    mockClient = new MockValidatorApiClient(mockClientConfig);
    operation = new LookupAnsEntryByName(mockClient);
