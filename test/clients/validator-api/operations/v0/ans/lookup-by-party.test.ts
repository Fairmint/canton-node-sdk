...
import { LookupAnsEntryByParty } from '../../../../../../src/LookupAnsEntryByParty';
import { mockClientConfig, mockApiUrls } from '../../../../../config/testConfig';

describe('LookupAnsEntryByParty Operation', () => {
  let mockClient: MockValidatorApiClient;
  let operation: InstanceType<typeof LookupAnsEntryByParty>;

  beforeEach(() => {
    mockClient = new MockValidatorApiClient(mockClientConfig);
    operation = new LookupAnsEntryByParty(mockClient);
