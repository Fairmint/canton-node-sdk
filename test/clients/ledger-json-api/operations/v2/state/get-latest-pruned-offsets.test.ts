...
import { GetLatestPrunedOffsets } from '../../../../../../src/GetLatestPrunedOffsets';
import { mockClientConfig, mockApiUrls } from '../../../../../config/testConfig';

describe('GetLatestPrunedOffsets Operation', () => {
  let mockClient: MockLedgerJsonApiClient;
  let operation: InstanceType<typeof GetLatestPrunedOffsets>;

  beforeEach(() => {
    mockClient = new MockLedgerJsonApiClient(mockClientConfig);
    operation = new GetLatestPrunedOffsets(mockClient);
  ...
  describe('Network Activity Validation', () => {
    it('should make a GET request to the correct endpoint', async () => {
      ...
      const params = {};
      const mockResponse = {};
      const expectedUrl = `${mockApiUrls.LEDGER_JSON_API}/v2/state/latest-pruned-offsets`;
