...
import { GetConnectedSynchronizers } from '../../../../../../src/GetConnectedSynchronizers';
import { mockClientConfig, mockApiUrls } from '../../../../../config/testConfig';

describe('GetConnectedSynchronizers Operation', () => {
  let mockClient: MockLedgerJsonApiClient;
  let operation: InstanceType<typeof GetConnectedSynchronizers>;

  beforeEach(() => {
    mockClient = new MockLedgerJsonApiClient(mockClientConfig);
    operation = new GetConnectedSynchronizers(mockClient);
  ...
  describe('Network Activity Validation', () => {
    it('should make a GET request to the correct endpoint', async () => {
      ...
      const params = {};
      const mockResponse = {};
      const expectedUrl = `${mockApiUrls.LEDGER_JSON_API}/v2/state/connected-synchronizers`;
