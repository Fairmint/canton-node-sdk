...
import { GetPartyDetails } from '../../../../../../src/GetPartyDetails';
import { mockClientConfig, mockApiUrls } from '../../../../../config/testConfig';

describe('GetPartyDetails Operation', () => {
  let mockClient: MockLedgerJsonApiClient;
  let operation: InstanceType<typeof GetPartyDetails>;

  beforeEach(() => {
    mockClient = new MockLedgerJsonApiClient(mockClientConfig);
    operation = new GetPartyDetails(mockClient);
