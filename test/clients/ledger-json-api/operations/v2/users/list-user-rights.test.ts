...
import { ListUserRights } from '../../../../../../src/ListUserRights';
import { mockClientConfig, mockApiUrls } from '../../../../../config/testConfig';

describe('ListUserRights Operation', () => {
  let mockClient: MockLedgerJsonApiClient;
  let operation: InstanceType<typeof ListUserRights>;

  beforeEach(() => {
    mockClient = new MockLedgerJsonApiClient(mockClientConfig);
    operation = new ListUserRights(mockClient);
