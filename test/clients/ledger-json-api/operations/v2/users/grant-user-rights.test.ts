...
import { GrantUserRights } from '../../../../../../src/GrantUserRights';
import { mockClientConfig, mockApiUrls } from '../../../../../config/testConfig';

describe('GrantUserRights Operation', () => {
  let mockClient: MockLedgerJsonApiClient;
  let operation: InstanceType<typeof GrantUserRights>;

  beforeEach(() => {
    mockClient = new MockLedgerJsonApiClient(mockClientConfig);
    operation = new GrantUserRights(mockClient);
