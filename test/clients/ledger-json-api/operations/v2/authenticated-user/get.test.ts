...
import { GetAuthenticatedUser } from '../../../../../../src/GetAuthenticatedUser';
import { mockClientConfig, mockApiUrls } from '../../../../../config/testConfig';

describe('GetAuthenticatedUser Operation', () => {
  let mockClient: MockLedgerJsonApiClient;
  let operation: InstanceType<typeof GetAuthenticatedUser>;

  beforeEach(() => {
    mockClient = new MockLedgerJsonApiClient(mockClientConfig);
    operation = new GetAuthenticatedUser(mockClient);
