...
import { GetPackageStatus } from '../../../../../../src/GetPackageStatus';
import { mockClientConfig, mockApiUrls } from '../../../../../config/testConfig';

describe('GetPackageStatus Operation', () => {
  let mockClient: MockLedgerJsonApiClient;
  let operation: InstanceType<typeof GetPackageStatus>;

  beforeEach(() => {
    mockClient = new MockLedgerJsonApiClient(mockClientConfig);
    operation = new GetPackageStatus(mockClient);
