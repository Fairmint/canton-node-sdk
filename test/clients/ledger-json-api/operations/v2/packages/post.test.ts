...
import { UploadDarFile } from '../../../../../../src/UploadDarFile';
import { mockClientConfig, mockApiUrls } from '../../../../../config/testConfig';

describe('UploadDarFile Operation', () => {
  let mockClient: MockLedgerJsonApiClient;
  let operation: InstanceType<typeof UploadDarFile>;

  beforeEach(() => {
    mockClient = new MockLedgerJsonApiClient(mockClientConfig);
    operation = new UploadDarFile(mockClient);
