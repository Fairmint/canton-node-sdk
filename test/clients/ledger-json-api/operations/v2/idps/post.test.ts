...
import { CreateIdentityProviderConfig } from '../../../../../../src/CreateIdentityProviderConfig';
import { mockClientConfig, mockApiUrls } from '../../../../../config/testConfig';

describe('CreateIdentityProviderConfig Operation', () => {
  let mockClient: MockLedgerJsonApiClient;
  let operation: InstanceType<typeof CreateIdentityProviderConfig>;

  beforeEach(() => {
    mockClient = new MockLedgerJsonApiClient(mockClientConfig);
    operation = new CreateIdentityProviderConfig(mockClient);
