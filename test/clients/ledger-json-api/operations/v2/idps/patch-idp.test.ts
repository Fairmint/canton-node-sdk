...
import { UpdateIdentityProviderConfig } from '../../../../../../src/UpdateIdentityProviderConfig';
import { mockClientConfig, mockApiUrls } from '../../../../../config/testConfig';

describe('UpdateIdentityProviderConfig Operation', () => {
  let mockClient: MockLedgerJsonApiClient;
  let operation: InstanceType<typeof UpdateIdentityProviderConfig>;

  beforeEach(() => {
    mockClient = new MockLedgerJsonApiClient(mockClientConfig);
    operation = new UpdateIdentityProviderConfig(mockClient);
