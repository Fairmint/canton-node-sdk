...
import { GetIdentityProviderConfig } from '../../../../../../src/GetIdentityProviderConfig';
import { mockClientConfig, mockApiUrls } from '../../../../../config/testConfig';

describe('GetIdentityProviderConfig Operation', () => {
  let mockClient: MockLedgerJsonApiClient;
  let operation: InstanceType<typeof GetIdentityProviderConfig>;

  beforeEach(() => {
    mockClient = new MockLedgerJsonApiClient(mockClientConfig);
    operation = new GetIdentityProviderConfig(mockClient);
