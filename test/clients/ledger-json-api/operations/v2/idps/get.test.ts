...
import { ListIdentityProviderConfigs } from '../../../../../../src/ListIdentityProviderConfigs';
import { mockClientConfig, mockApiUrls } from '../../../../../config/testConfig';

describe('ListIdentityProviderConfigs Operation', () => {
  let mockClient: MockLedgerJsonApiClient;
  let operation: InstanceType<typeof ListIdentityProviderConfigs>;

  beforeEach(() => {
    mockClient = new MockLedgerJsonApiClient(mockClientConfig);
    operation = new ListIdentityProviderConfigs(mockClient);
