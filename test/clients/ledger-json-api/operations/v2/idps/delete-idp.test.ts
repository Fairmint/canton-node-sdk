...
import { DeleteIdentityProviderConfig } from '../../../../../../src/DeleteIdentityProviderConfig';
import { mockClientConfig, mockApiUrls } from '../../../../../config/testConfig';

describe('DeleteIdentityProviderConfig Operation', () => {
  let mockClient: MockLedgerJsonApiClient;
  let operation: InstanceType<typeof DeleteIdentityProviderConfig>;

  beforeEach(() => {
    mockClient = new MockLedgerJsonApiClient(mockClientConfig);
    operation = new DeleteIdentityProviderConfig(mockClient);
