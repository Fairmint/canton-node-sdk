...
import { InteractiveSubmissionUploadDar } from '../../../../../../src/InteractiveSubmissionUploadDar';
import { mockClientConfig, mockApiUrls } from '../../../../../config/testConfig';

describe('InteractiveSubmissionUploadDar Operation', () => {
  let mockClient: MockLedgerJsonApiClient;
  let operation: InstanceType<typeof InteractiveSubmissionUploadDar>;

  beforeEach(() => {
    mockClient = new MockLedgerJsonApiClient(mockClientConfig);
    operation = new InteractiveSubmissionUploadDar(mockClient);
