...
import { InteractiveSubmissionGetPreferredPackageVersion } from '../../../../../../src/InteractiveSubmissionGetPreferredPackageVersion';
import { mockClientConfig, mockApiUrls } from '../../../../../config/testConfig';

describe('InteractiveSubmissionGetPreferredPackageVersion Operation', () => {
  let mockClient: MockLedgerJsonApiClient;
  let operation: InstanceType<typeof InteractiveSubmissionGetPreferredPackageVersion>;

  beforeEach(() => {
    mockClient = new MockLedgerJsonApiClient(mockClientConfig);
    operation = new InteractiveSubmissionGetPreferredPackageVersion(mockClient);
  ...
  describe('Network Activity Validation', () => {
    it('should make a GET request to the correct endpoint', async () => {
      ...
      const params = {};
      const mockResponse = {};
      const expectedUrl = `${mockApiUrls.LEDGER_JSON_API}/unknown`;
