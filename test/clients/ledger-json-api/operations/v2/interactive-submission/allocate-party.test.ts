...
import { InteractiveSubmissionAllocateParty } from '../../../../../../src/InteractiveSubmissionAllocateParty';
import { mockClientConfig, mockApiUrls } from '../../../../../config/testConfig';

describe('InteractiveSubmissionAllocateParty Operation', () => {
  let mockClient: MockLedgerJsonApiClient;
  let operation: InstanceType<typeof InteractiveSubmissionAllocateParty>;

  beforeEach(() => {
    mockClient = new MockLedgerJsonApiClient(mockClientConfig);
    operation = new InteractiveSubmissionAllocateParty(mockClient);
