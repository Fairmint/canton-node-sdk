...
import { InteractiveSubmissionGetPreferredPackages } from '../../../../../../src/InteractiveSubmissionGetPreferredPackages';
import { mockClientConfig, mockApiUrls } from '../../../../../config/testConfig';

describe('InteractiveSubmissionGetPreferredPackages Operation', () => {
  let mockClient: MockLedgerJsonApiClient;
  let operation: InstanceType<typeof InteractiveSubmissionGetPreferredPackages>;

  beforeEach(() => {
    mockClient = new MockLedgerJsonApiClient(mockClientConfig);
    operation = new InteractiveSubmissionGetPreferredPackages(mockClient);
