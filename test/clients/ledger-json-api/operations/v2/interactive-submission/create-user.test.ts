...
import { InteractiveSubmissionCreateUser } from '../../../../../../src/InteractiveSubmissionCreateUser';
import { mockClientConfig, mockApiUrls } from '../../../../../config/testConfig';

describe('InteractiveSubmissionCreateUser Operation', () => {
  let mockClient: MockLedgerJsonApiClient;
  let operation: InstanceType<typeof InteractiveSubmissionCreateUser>;

  beforeEach(() => {
    mockClient = new MockLedgerJsonApiClient(mockClientConfig);
    operation = new InteractiveSubmissionCreateUser(mockClient);
