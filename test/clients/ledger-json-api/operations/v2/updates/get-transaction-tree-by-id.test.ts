...
import { GetTransactionTreeById } from '../../../../../../src/GetTransactionTreeById';
import { mockClientConfig, mockApiUrls } from '../../../../../config/testConfig';

describe('GetTransactionTreeById Operation', () => {
  let mockClient: MockLedgerJsonApiClient;
  let operation: InstanceType<typeof GetTransactionTreeById>;

  beforeEach(() => {
    mockClient = new MockLedgerJsonApiClient(mockClientConfig);
    operation = new GetTransactionTreeById(mockClient);
  ...
  describe('Network Activity Validation', () => {
    it('should make a GET request to the correct endpoint', async () => {
      ...
      const params = {};
      const mockResponse = {};
      const expectedUrl = `${mockApiUrls.LEDGER_JSON_API}/v2/updates/transaction-tree-by-id/{update-id}`;
