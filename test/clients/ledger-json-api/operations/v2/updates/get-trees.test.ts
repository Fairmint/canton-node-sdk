...
import { GetUpdateTrees } from '../../../../../../src/GetUpdateTrees';
import { mockClientConfig, mockApiUrls } from '../../../../../config/testConfig';

describe('GetUpdateTrees Operation', () => {
  let mockClient: MockLedgerJsonApiClient;
  let operation: InstanceType<typeof GetUpdateTrees>;

  beforeEach(() => {
    mockClient = new MockLedgerJsonApiClient(mockClientConfig);
    operation = new GetUpdateTrees(mockClient);
