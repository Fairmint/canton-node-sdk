...
import { GetUpdateById } from '../../../../../../src/GetUpdateById';
import { mockClientConfig, mockApiUrls } from '../../../../../config/testConfig';

describe('GetUpdateById Operation', () => {
  let mockClient: MockLedgerJsonApiClient;
  let operation: InstanceType<typeof GetUpdateById>;

  beforeEach(() => {
    mockClient = new MockLedgerJsonApiClient(mockClientConfig);
    operation = new GetUpdateById(mockClient);
  ...
  describe('Network Activity Validation', () => {
    it('should make a POST request to the correct endpoint', async () => {
      ...
      const params = {};
      const mockResponse = {};
      const expectedUrl = `${mockApiUrls.LEDGER_JSON_API}/v2/updates/update-by-id`;
