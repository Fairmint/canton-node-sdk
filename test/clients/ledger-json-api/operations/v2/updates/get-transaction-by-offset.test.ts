...
import { GetTransactionByOffset } from '../../../../../../src/GetTransactionByOffset';
import { mockClientConfig, mockApiUrls } from '../../../../../config/testConfig';

describe('GetTransactionByOffset Operation', () => {
  let mockClient: MockLedgerJsonApiClient;
  let operation: InstanceType<typeof GetTransactionByOffset>;

  beforeEach(() => {
    mockClient = new MockLedgerJsonApiClient(mockClientConfig);
    operation = new GetTransactionByOffset(mockClient);
  ...
  describe('Network Activity Validation', () => {
    it('should make a POST request to the correct endpoint', async () => {
      ...
      const params = {};
      const mockResponse = {};
      const expectedUrl = `${mockApiUrls.LEDGER_JSON_API}/v2/updates/transaction-by-offset`;
