...
import { GetTransactionTreeByOffset } from '../../../../../../src/GetTransactionTreeByOffset';
import { mockClientConfig, mockApiUrls } from '../../../../../config/testConfig';

describe('GetTransactionTreeByOffset Operation', () => {
  let mockClient: MockLedgerJsonApiClient;
  let operation: InstanceType<typeof GetTransactionTreeByOffset>;

  beforeEach(() => {
    mockClient = new MockLedgerJsonApiClient(mockClientConfig);
    operation = new GetTransactionTreeByOffset(mockClient);
  ...
  describe('Network Activity Validation', () => {
    it('should make a GET request to the correct endpoint', async () => {
      ...
      const params = {};
      const mockResponse = {};
      const expectedUrl = `${mockApiUrls.LEDGER_JSON_API}/v2/updates/transaction-tree-by-offset/{offset}`;
