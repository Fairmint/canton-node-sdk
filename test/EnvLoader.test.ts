...
describe('EnvLoader', () => {
  ...
  describe('getWalletTemplateId', () => {
    it('should return wallet template ID for mainnet', () => {
      process.env['CANTON_WALLET_TEMPLATE_ID_MAINNET'] = 'test-wallet-template-mainnet';
    ...
    it('should return wallet template ID for devnet', () => {
      process.env['CANTON_WALLET_TEMPLATE_ID_DEVNET'] = 'test-wallet-template-devnet';
    ...
    it('should throw error when template ID is missing', () => {
      ...
      }).toThrow('Missing required environment variable: CANTON_WALLET_TEMPLATE_ID_MAINNET');
    });
  });

  describe('getPreapprovalTemplateId', () => {
    it('should return preapproval template ID for mainnet', () => {
      process.env['CANTON_PREAPPROVAL_TEMPLATE_ID_MAINNET'] = 'test-preapproval-template-mainnet';
      process.env['CANTON_CURRENT_NETWORK'] = 'mainnet';
    ...
    it('should return preapproval template ID for devnet', () => {
      process.env['CANTON_PREAPPROVAL_TEMPLATE_ID_DEVNET'] = 'test-preapproval-template-devnet';
      process.env['CANTON_CURRENT_NETWORK'] = 'devnet';
    ...
    it('should throw error when template ID is missing', () => {
      ...
      }).toThrow('Missing required environment variable: CANTON_PREAPPROVAL_TEMPLATE_ID_MAINNET');
    });
  });
  ...
  describe('getValidatorWalletAppInstallContractId', () => {
    it('should return validator wallet app install contract ID for mainnet', () => {
      process.env['CANTON_VALIDATOR_WALLET_APP_INSTALL_CONTRACT_ID_MAINNET'] = 'test-validator-wallet-app-install-contract-mainnet';
      process.env['CANTON_CURRENT_NETWORK'] = 'mainnet';
    ...
    it('should return validator wallet app install contract ID for devnet', () => {
      process.env['CANTON_VALIDATOR_WALLET_APP_INSTALL_CONTRACT_ID_DEVNET'] = 'test-validator-wallet-app-install-contract-devnet';
      process.env['CANTON_CURRENT_NETWORK'] = 'devnet';
  ...
  describe('getConfigSummary includes template and contract IDs', () => {
    it('should include template and contract IDs in config summary', () => {
      ...
      process.env['CANTON_VALIDATOR_WALLET_APP_INSTALL_CONTRACT_ID_MAINNET'] = 'test-validator-wallet-app-install-contract';
      ...
      expect(summary.envVars['CANTON_VALIDATOR_WALLET_APP_INSTALL_CONTRACT_ID_MAINNET']).toBe('test-validator-wallet-app-install-contract');
